...
// 获取文章
router.get('/:articleId', auth, articleValidator.getArticle, articleCtrl.getArticle)
...
// 删除文章评论
router.delete('/:articleId/comments/:commentId', articleCtrl.deleteArticleComment)
